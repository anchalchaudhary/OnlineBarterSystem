    ...
    public class User
    {
        ...
        public void SignUp(User objUser)
        {
            ...
            using (SqlConnection connect1 = new SqlConnection(connString))
            {
                    ...
                    {
                        using (SqlCommand cmdDetails = new SqlCommand("insert into tblUsers(Name, Email, Password, Gender, City, Phone, Dob, ProfilePicture, ActivationCode) values (@Name, @Email, @Password, @Gender, @City, @Phone, @Dob, @ProfilePicture, @ActivationCode)"))
                        {
                            ...
                            cmdDetails.Parameters.AddWithValue("@ActivationCode",objUser.ActivationCode);
                            //connect1.Open();
                    ...
                    {
                        using (SqlCommand cmdDetails = new SqlCommand("insert into tblUsers(Name, Email, Password, Gender, City, Phone, Dob, ActivationCode) values (@Name, @Email, @Password, @Gender, @City, @Phone, @Dob, @ActivationCode)"))
                        {
                            cmdDetails.Connection = connect1;
                            connect1.Open();
                            cmdDetails.Parameters.AddWithValue("@Name", objUser.Name);
