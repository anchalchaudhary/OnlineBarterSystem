...
<body>
    ...
    <div>
        <p>
            ...
            <asp:RequiredFieldValidator ID="RequiredGenre" runat="server" ControlToValidate="tbxGenreName" ErrorMessage="Enter Genre Name" ForeColor="Red"></asp:RequiredFieldValidator>
        </p>
        <p>
