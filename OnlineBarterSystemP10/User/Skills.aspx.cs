...
public partial class SearchSkills : System.Web.UI.Page
{
    ...
    protected DataSet GetData()
    {
        ...
        using (SqlConnection connect = new SqlConnection(str))
        {
            SqlDataAdapter da = new SqlDataAdapter("Select u.Email, s.SkillDetails from tblUserSkillMapping as s inner join tblUsers as u on u.Id=s.UserId where SkillId='" + ddlSkills.SelectedValue + "'", connect);//"Select * from tblUsers where Id='"+ userId + "'"  CHANGE IN REPEATER
